    ...
    >
      ...
      <div className="bg-brand-primary text-white text-xs py-2">
        <div className="section-padding flex justify-between items-center">
          <p className="hidden md:block">Livraison gratuite dès 100 DT | Paiement à la livraison | SAV 24/48h</p>
          <p className="md:hidden text-center w-full">Livraison gratuite dès 100 DT</p>
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link href="/espace-pro" className="hover:text-brand-accent transition-colors text-brand-accent font-semibold">Espace Pro</Link>
          </div>
        </div>
      </div>
