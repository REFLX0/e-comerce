...
export const TAXONOMY_ALIAS_GROUPS: Record<string, string[]> = {
  ...
  'auto-synthese': ['auto-synthese', 'huiles-moteur-auto'],
  'auto-semi': ['auto-semi', 'huiles-moteur-auto'],
  'auto-minerale': ['auto-minerale', 'huiles-moteur-auto'],
  'liquide-de-frein': ['liquide-de-frein', 'liquide-frein', 'liquide-frein-dot3', 'liquide-frein-dot4', 'liquide-frein-dot5-1'],
  'liquide-frein-dot3': ['liquide-frein-dot3', 'liquide-frein'],
  'liquide-frein-dot4': ['liquide-frein-dot4', 'liquide-frein'],
  'liquide-frein-dot5-1': ['liquide-frein-dot5-1', 'liquide-frein'],
  ...
  'additif-essence': ['additif-essence', 'additifs-carburant'],
  'additif-diesel': ['additif-diesel', 'additifs-carburant'],
  'additif-huile': ['additif-huile', 'additifs-huile'],
  'additif-boite-pont': ['additif-boite-pont'],
  ...
  'filtre-a-air': ['filtre-a-air', 'filtres-air', 'filtres'],
  'filtre-a-huile': ['filtre-a-huile', 'filtres-huile', 'filtres'],
  'filtre-a-carburant': ['filtre-a-carburant', 'filtres-carburant', 'filtres'],
  'filtre-habitacle': ['filtre-habitacle', 'filtres-habitacle', 'filtres'],
  'filtre-hydraulique': ['filtre-hydraulique', 'filtres'],
  'auto-freinage': ['auto-freinage', 'freinage', 'freins', 'disques-de-frein', 'plaquettes-de-frein'],
  'batteries': ['batteries', 'ap-cat-batterie', 'ap-cat-batteries'],
  ...
  'auto-electricite-eclairage': ['auto-electricite-eclairage', 'essuie-glaces'],
  ...
  'marine-moteurs': ['marine-moteurs'],
  'marine-hydraulique': ['marine-hydraulique'],
