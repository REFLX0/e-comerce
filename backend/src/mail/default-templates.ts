...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="text">
        Votre compte a été créé avec succès sur <strong>{{siteDomain}}</strong>. Vous pouvez dès à présent ajouter vos véhicules à votre garage virtuel, commander vos pièces certifiées et suivre l'état de vos livraisons.
      </p>
