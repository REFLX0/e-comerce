...
export class CategoriesController {
  ...
  @Post() create(@Body() body: { nameFr: string; slug: string; imageUrl?: string; parentId?: string }) {
  ...
  @Patch(':id') update(@Param('id') id: string, @Body() body: { nameFr?: string; slug?: string; imageUrl?: string; parentId?: string }) {
