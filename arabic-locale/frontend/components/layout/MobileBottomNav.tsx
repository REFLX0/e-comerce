      ...
      <div className="safe-pb flex items-center justify-around px-2 py-2">
        {links.map((link) => {
          const isActive = link.exact
            ? pathname === link.href || pathname === `/${locale}${link.href}` || pathname === `/fr${link.href}` || pathname === `/en${link.href}` || pathname === `/ar${link.href}`
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                ...
                {link.badge != null && (
                  <span className="absolute -top-2 -end-2.5 flex h-4.5 min-w-[18px] items-center justify-center rounded-full bg-brand-primary px-1 text-[10px] leading-none font-black text-white">
