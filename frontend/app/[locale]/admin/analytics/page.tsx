  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {[
          { label: "Chiffre d'affaires", value: money(stats.totalRevenue ?? 0), icon: DollarSign, trend: '+12.5%', good: true },
          { label: 'Commandes', value: stats.totalOrders ?? 0, icon: ShoppingCart, trend: '+5.2%', good: true },
          { label: 'Clients', value: stats.totalUsers ?? 0, icon: Users, trend: '+18.1%', good: true },
          { label: 'Panier moyen', value: money(avgOrderValue), icon: Package, trend: '-1.8%', good: false },
        ].map((kpi) => (
