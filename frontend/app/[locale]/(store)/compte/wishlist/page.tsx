  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-brand-primary">{t('myWishlist')}</h1>
          <p className="text-sm text-gray-500">{t('savedProducts', { count: items.length })}</p>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="py-16 text-center">
          ...
          <p className="font-semibold text-gray-400">{t('wishlistEmpty')}</p>
