    ...
    <>
      ...
      <div className="section-padding py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
          {[
            { icon: Phone, title: 'Téléphone', info: '+216 92 975 959', sub: 'Lun-Ven 8h-18h | Sam 8h-14h' },
            { icon: Mail, title: 'Email', info: 'contact@bestoil.tn', sub: 'Réponse sous 24h' },
            { icon: MapPin, title: 'Adresse', info: 'Route Manzel Chaker Km 1', sub: 'Rue Kerbala, 3072 Sfax' },
            { icon: Clock, title: 'Horaires', info: 'Lun-Ven: 8h-18h', sub: 'Sam: 8h-14h | Dim: Fermé' },
          ].map((c) => (
