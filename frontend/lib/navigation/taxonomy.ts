  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: 'Freinage',
        labelKey: 'freinage',
        hint: 'Disques, Plaquettes, Étriers',
      ...
      },
      {
        ...
        label: 'Batteries',
        labelKey: 'batteries',
        hint: 'Démarrage, Stop & Start, AGM, EFB',
      ...
      },
      {
        ...
        hint: 'Amortisseurs, Rotules, Bras',
      ...
      },
      {
        ...
        hint: 'Embrayage, Boîte, Cardans',
        hintKey: 'huileBoite',
      },
      { slug: 'auto-moteur-distribution', label: 'Moteur et Distribution', labelKey: 'moteurDistribution', hint: 'Courroies, Chaînes, Pompes' },
      { slug: 'auto-refroidissement-climatisation', label: 'Refroidissement et Climatisation', labelKey: 'refroidissement', hint: 'Radiateurs, Thermostats' },
      { slug: 'auto-electricite-eclairage', label: 'Électricité et Éclairage', labelKey: 'electricite', hint: 'Alternateurs, Démarreurs' },
      { slug: 'auto-carrosserie-habitacle', label: 'Carrosserie et Habitacle', labelKey: 'carrosserie', hint: 'Rétroviseurs, Essuie-glaces' },
      { slug: 'auto-autres-pieces', label: 'Échappement et Autres Pièces', labelKey: 'autresPieces', hint: 'Silencieux, Catalyseurs' },
    ],
  },
  {
    slug: 'moto-karting',
