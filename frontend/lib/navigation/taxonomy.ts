...
export const NAVIGATION_TAXONOMY: NavigationTaxonomyItem[] = [
  {
    ...
    children: [
      ...
      {
        slug: 'huile-de-boite',
        label: 'Huile de boîte & transmission',
        labelKey: 'huileBoite',
        hint: 'ATF, DSG, DCT, 75W-80, 75W-90, Hypoïde',
        hintKey: 'gearboxHint',
      },
      {
        slug: 'additifs',
        label: 'Additifs',
        labelKey: 'additifs',
        hint: 'Additif Essence, Additif Diesel, Additif Huile & Rinçage',
        ...
        children: [
          ...
          { slug: 'additif-huile', label: 'Additif Huile & Rinçage', labelKey: 'additifHuile' },
        ],
      },
      {
        slug: 'liquides-auto',
        label: 'Liquides & Entretien',
        hint: 'Antigel, AdBlue, Lave-glace',
      },
    ],
  },
  {
