...
function CategoryChoice({
  ...
  return (
    <button
      ...
      onClick={onClick}
      aria-pressed={active}
      className={`flex min-h-9 w-full items-center justify-between gap-3 border-l-2 px-3 text-left text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E10600]/30 ${
