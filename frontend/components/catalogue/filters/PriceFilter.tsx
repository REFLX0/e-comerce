      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        <label className="relative block">
          ...
          <input
            ...
            className="h-10 w-full border border-black/15 bg-white px-2.5 pr-9 text-xs font-semibold text-[#111] outline-none transition-colors placeholder:text-neutral-400 focus:border-[#E10600]"
          />
          <span
            aria-hidden="true"
            className="pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-[10px] font-bold text-neutral-400"
          >
            DT
          </span>
        </label>
