...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'text-base leading-tight font-semibold tracking-normal group-data-[size=sm]/card:text-sm',
        className
      )}
      {...props}
    />
