          ...
          {navigationCategories.map((category) => {
            ...
            return (
              <div key={category.id} className="relative" onMouseEnter={() => openDropdown(category.slug)} onMouseLeave={scheduleClose}>
                ...
                {hasChildren && isOpen && (
                  <div className="absolute left-0 top-full z-50 w-[min(920px,calc(100vw-2rem))] overflow-hidden rounded-b-2xl border border-slate-200 bg-white shadow-[0_18px_40px_rgba(22,37,76,0.16)]" onMouseEnter={() => openDropdown(category.slug)} onMouseLeave={scheduleClose}>
