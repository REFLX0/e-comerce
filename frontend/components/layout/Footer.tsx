  ...
  return (
    <footer className="relative mt-auto overflow-hidden bg-brand-primary-dark">
      ...
      <div className="section-padding relative pt-16 pb-10">
        <div className="mb-14 grid grid-cols-1 gap-12 border-b border-white/10 pb-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mb-6 text-sm leading-relaxed text-white/50 max-w-xs">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-lg bg-white/10 text-white/60
            ...
            <ul className="space-y-3 text-sm">
              {[
                ...
                <li key={href}>
                  <Link
                    href={href}
                    className="group flex min-h-11 items-center gap-2 text-white/50 transition-colors duration-200 hover:text-white"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+21692975959" className="flex min-h-11 items-center text-white/50 transition-colors duration-200 hover:text-white">
                  +216 92 975 959
                </a>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:contact@kiosquetn.tn" className="flex min-h-11 items-center text-white/50 transition-colors duration-200 hover:text-white">
        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex flex-col items-center gap-2 text-xs text-white/20 md:items-end">
            ...
            <p className="text-white/10">Made By Mohamed Harbi & Mohamed Aziz Jlassi </p>
          </div>
        </div>
      </div>
    </footer>
